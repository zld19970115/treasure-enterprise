...
@Slf4j
@RestController
@RequestMapping("/api/alif2f")
@Api(tags="支付宝-当面付接口")
public class ApiAlipayF2FPayController {
...
//                ZxingUtils.getQRCodeImge(res.getQrCode(), 256, filePath);
    ...
    public String refund(String orderNo){
        ...
        AlipayTradeRefundRequestBuilder builder = new AlipayTradeRefundRequestBuilder()
                .setOutTradeNo(orderNo)               //订单编号
                .setRefundAmount("0.01")              //退款金额
                .setRefundReason("当面付退款测试")    //退款说明
                .setOutRequestNo(String.valueOf(System.nanoTime()))//退款单号
                .setStoreId("A1");   //门店编号
