...
public class ApiMasterOrderController {
    ...
    public Result<PageData<MerchantOrderDTO>> ongPage(@ApiIgnore @RequestParam Map<String, Object> params){
        params.put("status", Constants.OrderStatus.MERCHANTRECEIPTORDER.getValue()+","+Constants.OrderStatus.MERCHANTREFUSESREFUNDORDER.getValue()+","+Constants.OrderStatus.MERCHANTAGREEREFUNDORDER.getValue());
