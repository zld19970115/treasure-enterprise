...
public class CtDaysTogetherServicelmpl  extends CrudServiceImpl<CtDaysTogetherDao, CtDaysTogetherEntity, CtDaysTogetherDTO> implements CtDaysTogetherService {
    ...
    public int decideInsertOrUpdate(Date date,long merchantId,String type,StatsDayDetailEntity sdde) {
        ...
        if(null !=cdt){
            ...
            BigDecimal payCoin = cdt.getPayCoins();
            ...
            BigDecimal newpayCoin = payCoin.add(sdde.getYePaymoney());
            ...
            if( null!=wxPaymoney ){
                cdte.setPayType("3");
            }else if( null!=aliPaymoney ) {
                cdte.setPayType("2");
            }else if( null!=YePaymoney ) {
                cdte.setPayType("1");
            }
            ...
            cdte.setPayCoins(sdde.getYePaymoney());
